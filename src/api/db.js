...
const accessToken = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3NzY3ZmMzYmRhODllOGMwOWFhZWM0ZSIsImlhdCI6MTczNTgxOTIxOCwiZXhwIjoxNzM1OTkyMDE4fQ.8snBmc_2MFf6BF62faNWHa0w2o_9Zk4J5J__6rx3RBk`;

async function createProducts(productsArray) {
  for (const product of productsArray) {
    await createProductApi({ productObject: product });
  }
}
